...
<template>
    <div class="relative w-20 h-20 mb-6 m-auto cursor-pointer bg-none bg-black group last:w-28 last:h-28 last:mt-60">
        <a :href="link">
            ...
            <div :class="$attrs.class" class="bg-auto bg-no-repeat bg-center w-full h-full"></div>
        </a>
    </div>
</template>
