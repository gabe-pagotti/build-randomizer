...
<template>
    <div class="relative w-22 h-22 mb-8 m-auto cursor-pointer bg-black bg-no-repeat bg-110 bg-center shadow-lt group last:w-28 last:h-28 last:mt-80" @click="followLink()">
