...
<template>
    <div class="relative w-22 h-22 cursor-pointer bg-black bg-no-repeat bg-110 bg-center shadow-lt group last:w-28 last:h-28 last:mt-auto last:mb-28" @click="followLink()">
